// Verified Python and JavaScript solutions for the pilot problems.
// Extracted from `pilot_languages_test.dart` so the coverage gate in
// `language_coverage_test.dart` can check the same set without importing a
// test file.
