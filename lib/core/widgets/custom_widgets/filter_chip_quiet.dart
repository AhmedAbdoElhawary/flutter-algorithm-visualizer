    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            MediumText(label, color: selected ? ThemeEnum.inkTitle : ThemeEnum.inkSecondaryTitle, fontSize: 12),
            if (count != null && count!.isNotEmpty) ...[
              const RSizedBox(width: 5),
              MediumText(count!, color: selected ? ThemeEnum.inkTitle : ThemeEnum.inkSecondaryTitle, fontSize: 11),
            ],
          ],
        ),
      ),
