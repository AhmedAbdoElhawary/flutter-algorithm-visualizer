...
class _CodeEditorBlockState extends State<CodeEditorBlock> with SingleTickerProviderStateMixin {
  ...
  void _highlightLine() {
    ...
    controller.highlightLine(widget.highlightLineNumber, ColorManager.highlightCodeLineColor);
  }
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Spacer(),
                if (widget.executing)
                  MediumText(StringsManager.executing, color: ThemeEnum.greenColor, fontSize: 10)
              ],
            ),
          ),
