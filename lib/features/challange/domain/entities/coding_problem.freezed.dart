...
mixin _$CodingProblem {
  ...
  List<SimilarQuestion>? get similarQuestions =>
      throw _privateConstructorUsedError; // storage
  ...
  /// Serializes this CodingProblem to a JSON map.
...
/// @nodoc
abstract class _$$CodingProblemImplCopyWith<$Res>
    implements $CodingProblemCopyWith<$Res> {
  factory _$$CodingProblemImplCopyWith(
          _$CodingProblemImpl value, $Res Function(_$CodingProblemImpl) then) =
      __$$CodingProblemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? number,
...
/// @nodoc
class __$$CodingProblemImplCopyWithImpl<$Res>
    extends _$CodingProblemCopyWithImpl<$Res, _$CodingProblemImpl>
    implements _$$CodingProblemImplCopyWith<$Res> {
  __$$CodingProblemImplCopyWithImpl(
      _$CodingProblemImpl _value, $Res Function(_$CodingProblemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CodingProblemImpl(
      number: freezed == number
          ? _value.number
          : number // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CodingProblemImpl implements _CodingProblem {
  const _$CodingProblemImpl(
  ...
  factory _$CodingProblemImpl.fromJson(Map<String, dynamic> json) =>
      _$$CodingProblemImplFromJson(json);
...
// storage
  ...
  int get hashCode => Object.hashAll([
        ...
        problemStatus,
        isBookmarked,
        const DeepCollectionEquality().hash(_solutionsStatus)
      ]);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CodingProblemImplCopyWith<_$CodingProblemImpl> get copyWith =>
      __$$CodingProblemImplCopyWithImpl<_$CodingProblemImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CodingProblemImplToJson(
      this,
    );
  }
}
...
abstract class _CodingProblem implements CodingProblem {
  ...
  List<String>? get commonMistakes;
  @override
  List<SimilarQuestion>? get similarQuestions; // storage
  @override
