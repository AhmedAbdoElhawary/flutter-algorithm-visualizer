...
CodingProblem _$CodingProblemFromJson(Map<String, dynamic> json) => CodingProblem(
      number: (json['number'] as num?)?.toInt(),
      problemId: (json['problem_id'] as num?)?.toInt(),
      name: json['name'] as String?,
      source: json['source'] as String?,
      sourceProblemNumber: (json['source_problem_number'] as num?)?.toInt(),
      difficulty: $enumDecodeNullable(_$ProblemDifficultyEnumMap, json['difficulty']),
      category: json['category'] as String?,
      tags: (json['tags'] as List<dynamic>?)?.map((e) => e as String).toList(),
      patterns: (json['patterns'] as List<dynamic>?)?.map((e) => e as String).toList(),
      description: json['description'] as String?,
      constraints: (json['constraints'] as List<dynamic>?)?.map((e) => e as String).toList(),
      functionSignature: json['function_signature'] == null
          ? null
          : FunctionSignature.fromJson(json['function_signature'] as Map<String, dynamic>),
      defaultCode: (json['default_code'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, e as String),
      ),
      customObjects: (json['custom_objects'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, (e as List<dynamic>).map(CustomObject.fromJson).toList()),
      ),
      examples: (json['examples'] as List<dynamic>?)
          ?.map((e) => Example.fromJson(e as Map<String, dynamic>))
          .toList(),
      edgeCases: (json['edge_cases'] as List<dynamic>?)?.map((e) => e as String).toList(),
      ...
      solutionApproach: json['solution_approach'] == null
          ? null
          : SolutionApproach.fromJson(json['solution_approach'] as Map<String, dynamic>),
      ...
      followUpConcepts: (json['follow_up_concepts'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
Map<String, dynamic> _$CodingProblemToJson(CodingProblem instance) => <String, dynamic>{
      ...
      'custom_objects': instance.customObjects?.map((k, e) => MapEntry(k, e.map((e) => e.toJson()).toList())),
      ...
      'hidden_test_cases': instance.hiddenTestCases?.map((e) => e.toJson()).toList(),
