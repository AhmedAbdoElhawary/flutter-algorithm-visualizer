...
class BaseCategory {
  final Map<String, AlgoSortingCard> sortingCards;
  final Map<String, AlgoSearchingCard> searchingCards;
  BaseCategory({required this.sortingCards, required this.searchingCards});
}

class BaseViewModel {
  static final BaseCategory baseCategory = BaseCategory(
    sortingCards: _sortingCards,
    searchingCards: _searchingCards,
  );

  static final Map<String, AlgoSortingCard> _sortingCards = {
  ...
  static final Map<String, AlgoSearchingCard> _searchingCards = {
