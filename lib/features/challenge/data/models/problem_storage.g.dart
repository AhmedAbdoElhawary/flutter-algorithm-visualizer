...
Map<String, dynamic> _$ProblemStorageDTOToJson(ProblemStorageDTO instance) => <String, dynamic>{
...
ProblemSolutionStatusDTO _$ProblemSolutionStatusDTOFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ProblemSolutionStatusDTOToJson(ProblemSolutionStatusDTO instance) => <String, dynamic>{
      'code': instance.code,
      'all_test_case_results': instance.allTestCaseResults?.map((e) => e.toJson()).toList(),
