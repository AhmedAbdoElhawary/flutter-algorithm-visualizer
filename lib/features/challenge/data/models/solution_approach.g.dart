...
SolutionApproach _$SolutionApproachFromJson(Map<String, dynamic> json) => SolutionApproach(
...
Map<String, dynamic> _$SolutionApproachToJson(SolutionApproach instance) => <String, dynamic>{
