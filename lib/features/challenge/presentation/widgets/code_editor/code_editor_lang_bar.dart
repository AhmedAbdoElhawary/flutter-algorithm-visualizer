...
//                 ),
//                 child: SemiBoldText(language,
//                     color: ThemeEnum.textSecond, fontSize: 12),
//               ),
//             ),
//             const Spacer(),
//             GestureDetector(
...
//                     final copied =
//                         ref.watch(provider.select((value) => value.copied));
//
//                     return CustomIcon(
...
//               builder: (context, ref, child) {
//                 final isRunning =
//                     ref.watch(provider.select((value) => value.isRunning));
//
...
//                               finalResult = result;
//                               if (!(!result.allPassed &&
//                                   problem.isThereAnyCorrectCodeSaved)) {
//                                 await ref
//                                     .read(challengesProvider.notifier)
//                                     .updateProblemSubmission(problem, result);
//                               }
//                             },
//                           );
...
//                                 dayStreak: ref
//                                     .read(profileStatisticsProvider)
//                                     .currentStreak,
//                               ),
//                             );
//                           }
...
//                     decoration: BoxDecoration(
//                       color: context.getColor(isRunning
...
//                           : null,
//                       boxShadow: isRunning ? null : context.cdGlow,
//                     ),
//                     child: Row(
