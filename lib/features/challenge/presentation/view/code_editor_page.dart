...
//         ? (ref
//                 .watch(homeDataProvider.select((s) => s.continueProblem))
//                 ?.getProblemId ??
//             -1)
//         : widget.problemId;
//
...
//     ref.listen<bool>(provider.select((s) => s.isRunning),
...
//
//                       final highlightedLine = ref.watch(
//                           provider.select((value) => value.highlightedLine));
//                       final isRunning = ref
//                           .watch(provider.select((value) => value.isRunning));
//
...
//                     builder: (context, ref, child) {
//                       final grade =
//                           ref.watch(provider.select((value) => value.grade));
//
//                       if (grade != null) {
//                         return SliverPadding(
//                           key: _resultKey,
