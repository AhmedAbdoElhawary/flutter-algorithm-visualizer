...
When an incident does occur, it is important to report it promptly. To report a possible violation, email the project maintainer at **elhawarydev@gmail.com**.

Reports are handled by the project maintainer, who will make every effort to respond in a timely manner. All reports are investigated by reviewing messages, logs, and any other available context. Investigation and enforcement will be kept as transparent as possible while prioritizing the safety and confidentiality of everyone involved. Enforcement actions are carried out in private with the involved parties, though communicating to the whole community may be part of a mutually agreed upon resolution.
...
**4. Permanent Ban**
- *Event:* A pattern of repeated code of conduct violations that other steps on the ladder have failed to resolve, or a violation so serious that there is no way to keep the community safe with this person as a member.
...
This Code of Conduct applies within all community spaces — including this repository's issues, pull requests, discussions, and any official communication channel — and also applies when an individual is officially representing the community in public or other spaces.
