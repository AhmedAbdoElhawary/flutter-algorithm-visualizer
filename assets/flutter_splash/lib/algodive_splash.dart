...
///
/// The native launch screen shows the static mark on the brand ground; this
/// widget picks the motion up on the first Flutter frame, finishes the mark,
/// writes the wordmark and raises the sorted bars, then calls [onFinished].
class AlgoDiveSplash extends StatefulWidget {
  const AlgoDiveSplash({super.key, required this.onFinished, this.dark = true});
                      ...
                      child: Transform.translate(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            letterSpacing: -1.9,
                            // Bundle IBM Plex Sans Arabic and name it here.
...
///     if (!_ready) {
///       return AlgoDiveSplash(dark: dark, onFinished: () => setState(() => _ready = true));
///     }
///     return const HomeScreen();
///   }
///
/// Run Firebase.initializeApp() and your local-storage open in initState and
/// gate on Future.wait([animation, init]) so the splash never outlives the work.
